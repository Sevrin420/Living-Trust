...
//
// P33 address: read from xPHAR contract on Snowscan:
//   https://snowscan.xyz/address/0xE8164Ea89665DAb7a553e667F81F30CfDA736B9A#readContract
//   (look for a P33 or AUTO_VAULT() getter)

const ADDRESSES: Record<number, { phar: string; xphar: string; p33: string }> = {
  // ── Avalanche Mainnet ──────────────────────────────────────────────────────
  43114: {
    phar:  "0x13A466998Ce03Db73aBc2d4DF3bBD845Ed1f28E7", // confirmed
    xphar: "0xE8164Ea89665DAb7a553e667F81F30CfDA736B9A", // confirmed
    p33:   "0x0000000000000000000000000000000000000000",  // TODO: read from xPHAR contract
  },
  ...
  43113: {
    ...
    p33:   "0x0000000000000000000000000000000000000000",
  },
};
...
async function main() {
  ...
  console.log(`2. Verify: npx hardhat verify --network avalanche ${address} ${cfg.p33} ${cfg.phar} ${cfg.xphar}`);
}
